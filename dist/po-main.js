(()=>{var U=globalThis,z=U.ShadowRoot&&(U.ShadyCSS===void 0||U.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,D=Symbol(),le=new WeakMap,w=class{constructor(e,t,i){if(this._$cssResult$=!0,i!==D)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(z&&e===void 0){let i=t!==void 0&&t.length===1;i&&(e=le.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),i&&le.set(t,e))}return e}toString(){return this.cssText}},de=o=>new w(typeof o=="string"?o:o+"",void 0,D),h=(o,...e)=>{let t=o.length===1?o[0]:e.reduce((i,s,a)=>i+(r=>{if(r._$cssResult$===!0)return r.cssText;if(typeof r=="number")return r;throw Error("Value passed to 'css' function must be a 'css' function result: "+r+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+o[a+1],o[0]);return new w(t,o,D)},pe=(o,e)=>{if(z)o.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let i=document.createElement("style"),s=U.litNonce;s!==void 0&&i.setAttribute("nonce",s),i.textContent=t.cssText,o.appendChild(i)}},B=z?o=>o:o=>o instanceof CSSStyleSheet?(e=>{let t="";for(let i of e.cssRules)t+=i.cssText;return de(t)})(o):o;var{is:Ue,defineProperty:ze,getOwnPropertyDescriptor:He,getOwnPropertyNames:Ne,getOwnPropertySymbols:Re,getPrototypeOf:De}=Object,H=globalThis,ce=H.trustedTypes,Be=ce?ce.emptyScript:"",qe=H.reactiveElementPolyfillSupport,T=(o,e)=>o,q={toAttribute(o,e){switch(e){case Boolean:o=o?Be:null;break;case Object:case Array:o=o==null?o:JSON.stringify(o)}return o},fromAttribute(o,e){let t=o;switch(e){case Boolean:t=o!==null;break;case Number:t=o===null?null:Number(o);break;case Object:case Array:try{t=JSON.parse(o)}catch{t=null}}return t}},he=(o,e)=>!Ue(o,e),me={attribute:!0,type:String,converter:q,reflect:!1,useDefault:!1,hasChanged:he};Symbol.metadata??=Symbol("metadata"),H.litPropertyMetadata??=new WeakMap;var b=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=me){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let i=Symbol(),s=this.getPropertyDescriptor(e,i,t);s!==void 0&&ze(this.prototype,e,s)}}static getPropertyDescriptor(e,t,i){let{get:s,set:a}=He(this.prototype,e)??{get(){return this[t]},set(r){this[t]=r}};return{get:s,set(r){let m=s?.call(this);a?.call(this,r),this.requestUpdate(e,m,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??me}static _$Ei(){if(this.hasOwnProperty(T("elementProperties")))return;let e=De(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(T("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(T("properties"))){let t=this.properties,i=[...Ne(t),...Re(t)];for(let s of i)this.createProperty(s,t[s])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[i,s]of t)this.elementProperties.set(i,s)}this._$Eh=new Map;for(let[t,i]of this.elementProperties){let s=this._$Eu(t,i);s!==void 0&&this._$Eh.set(s,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let i=new Set(e.flat(1/0).reverse());for(let s of i)t.unshift(B(s))}else e!==void 0&&t.push(B(e));return t}static _$Eu(e,t){let i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let i of t.keys())this.hasOwnProperty(i)&&(e.set(i,this[i]),delete this[i]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return pe(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ET(e,t){let i=this.constructor.elementProperties.get(e),s=this.constructor._$Eu(e,i);if(s!==void 0&&i.reflect===!0){let a=(i.converter?.toAttribute!==void 0?i.converter:q).toAttribute(t,i.type);this._$Em=e,a==null?this.removeAttribute(s):this.setAttribute(s,a),this._$Em=null}}_$AK(e,t){let i=this.constructor,s=i._$Eh.get(e);if(s!==void 0&&this._$Em!==s){let a=i.getPropertyOptions(s),r=typeof a.converter=="function"?{fromAttribute:a.converter}:a.converter?.fromAttribute!==void 0?a.converter:q;this._$Em=s;let m=r.fromAttribute(t,a.type);this[s]=m??this._$Ej?.get(s)??m,this._$Em=null}}requestUpdate(e,t,i,s=!1,a){if(e!==void 0){let r=this.constructor;if(s===!1&&(a=this[e]),i??=r.getPropertyOptions(e),!((i.hasChanged??he)(a,t)||i.useDefault&&i.reflect&&a===this._$Ej?.get(e)&&!this.hasAttribute(r._$Eu(e,i))))return;this.C(e,t,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:i,reflect:s,wrapped:a},r){i&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,r??t??this[e]),a!==!0||r!==void 0)||(this._$AL.has(e)||(this.hasUpdated||i||(t=void 0),this._$AL.set(e,t)),s===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[s,a]of this._$Ep)this[s]=a;this._$Ep=void 0}let i=this.constructor.elementProperties;if(i.size>0)for(let[s,a]of i){let{wrapped:r}=a,m=this[s];r!==!0||this._$AL.has(s)||m===void 0||this.C(s,void 0,a,m)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(t)):this._$EM()}catch(i){throw e=!1,this._$EM(),i}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};b.elementStyles=[],b.shadowRootOptions={mode:"open"},b[T("elementProperties")]=new Map,b[T("finalized")]=new Map,qe?.({ReactiveElement:b}),(H.reactiveElementVersions??=[]).push("2.1.2");var K=globalThis,ue=o=>o,N=K.trustedTypes,ge=N?N.createPolicy("lit-html",{createHTML:o=>o}):void 0,xe="$lit$",v=`lit$${Math.random().toFixed(9).slice(2)}$`,Ae="?"+v,Ie=`<${Ae}>`,_=document,j=()=>_.createComment(""),C=o=>o===null||typeof o!="object"&&typeof o!="function",X=Array.isArray,Ge=o=>X(o)||typeof o?.[Symbol.iterator]=="function",I=`[ 	
\f\r]`,k=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,fe=/-->/g,be=/>/g,x=RegExp(`>|${I}(?:([^\\s"'>=/]+)(${I}*=${I}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ye=/'/g,$e=/"/g,_e=/^(?:script|style|textarea|title)$/i,Y=o=>(e,...t)=>({_$litType$:o,strings:e,values:t}),l=Y(1),Ze=Y(2),Qe=Y(3),y=Symbol.for("lit-noChange"),c=Symbol.for("lit-nothing"),ve=new WeakMap,A=_.createTreeWalker(_,129);function Se(o,e){if(!X(o)||!o.hasOwnProperty("raw"))throw Error("invalid template strings array");return ge!==void 0?ge.createHTML(e):e}var Ve=(o,e)=>{let t=o.length-1,i=[],s,a=e===2?"<svg>":e===3?"<math>":"",r=k;for(let m=0;m<t;m++){let n=o[m],u,g,d=-1,f=0;for(;f<n.length&&(r.lastIndex=f,g=r.exec(n),g!==null);)f=r.lastIndex,r===k?g[1]==="!--"?r=fe:g[1]!==void 0?r=be:g[2]!==void 0?(_e.test(g[2])&&(s=RegExp("</"+g[2],"g")),r=x):g[3]!==void 0&&(r=x):r===x?g[0]===">"?(r=s??k,d=-1):g[1]===void 0?d=-2:(d=r.lastIndex-g[2].length,u=g[1],r=g[3]===void 0?x:g[3]==='"'?$e:ye):r===$e||r===ye?r=x:r===fe||r===be?r=k:(r=x,s=void 0);let $=r===x&&o[m+1].startsWith("/>")?" ":"";a+=r===k?n+Ie:d>=0?(i.push(u),n.slice(0,d)+xe+n.slice(d)+v+$):n+v+(d===-2?m:$)}return[Se(o,a+(o[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]},M=class o{constructor({strings:e,_$litType$:t},i){let s;this.parts=[];let a=0,r=0,m=e.length-1,n=this.parts,[u,g]=Ve(e,t);if(this.el=o.createElement(u,i),A.currentNode=this.el.content,t===2||t===3){let d=this.el.content.firstChild;d.replaceWith(...d.childNodes)}for(;(s=A.nextNode())!==null&&n.length<m;){if(s.nodeType===1){if(s.hasAttributes())for(let d of s.getAttributeNames())if(d.endsWith(xe)){let f=g[r++],$=s.getAttribute(d).split(v),O=/([.?@])?(.*)/.exec(f);n.push({type:1,index:a,name:O[2],strings:$,ctor:O[1]==="."?V:O[1]==="?"?J:O[1]==="@"?F:E}),s.removeAttribute(d)}else d.startsWith(v)&&(n.push({type:6,index:a}),s.removeAttribute(d));if(_e.test(s.tagName)){let d=s.textContent.split(v),f=d.length-1;if(f>0){s.textContent=N?N.emptyScript:"";for(let $=0;$<f;$++)s.append(d[$],j()),A.nextNode(),n.push({type:2,index:++a});s.append(d[f],j())}}}else if(s.nodeType===8)if(s.data===Ae)n.push({type:2,index:a});else{let d=-1;for(;(d=s.data.indexOf(v,d+1))!==-1;)n.push({type:7,index:a}),d+=v.length-1}a++}}static createElement(e,t){let i=_.createElement("template");return i.innerHTML=e,i}};function S(o,e,t=o,i){if(e===y)return e;let s=i!==void 0?t._$Co?.[i]:t._$Cl,a=C(e)?void 0:e._$litDirective$;return s?.constructor!==a&&(s?._$AO?.(!1),a===void 0?s=void 0:(s=new a(o),s._$AT(o,t,i)),i!==void 0?(t._$Co??=[])[i]=s:t._$Cl=s),s!==void 0&&(e=S(o,s._$AS(o,e.values),s,i)),e}var G=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:i}=this._$AD,s=(e?.creationScope??_).importNode(t,!0);A.currentNode=s;let a=A.nextNode(),r=0,m=0,n=i[0];for(;n!==void 0;){if(r===n.index){let u;n.type===2?u=new P(a,a.nextSibling,this,e):n.type===1?u=new n.ctor(a,n.name,n.strings,this,e):n.type===6&&(u=new W(a,this,e)),this._$AV.push(u),n=i[++m]}r!==n?.index&&(a=A.nextNode(),r++)}return A.currentNode=_,s}p(e){let t=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}},P=class o{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,s){this.type=2,this._$AH=c,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=S(this,e,t),C(e)?e===c||e==null||e===""?(this._$AH!==c&&this._$AR(),this._$AH=c):e!==this._$AH&&e!==y&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Ge(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==c&&C(this._$AH)?this._$AA.nextSibling.data=e:this.T(_.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:i}=e,s=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=M.createElement(Se(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(t);else{let a=new G(s,this),r=a.u(this.options);a.p(t),this.T(r),this._$AH=a}}_$AC(e){let t=ve.get(e.strings);return t===void 0&&ve.set(e.strings,t=new M(e)),t}k(e){X(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,i,s=0;for(let a of e)s===t.length?t.push(i=new o(this.O(j()),this.O(j()),this,this.options)):i=t[s],i._$AI(a),s++;s<t.length&&(this._$AR(i&&i._$AB.nextSibling,s),t.length=s)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let i=ue(e).nextSibling;ue(e).remove(),e=i}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},E=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,s,a){this.type=1,this._$AH=c,this._$AN=void 0,this.element=e,this.name=t,this._$AM=s,this.options=a,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=c}_$AI(e,t=this,i,s){let a=this.strings,r=!1;if(a===void 0)e=S(this,e,t,0),r=!C(e)||e!==this._$AH&&e!==y,r&&(this._$AH=e);else{let m=e,n,u;for(e=a[0],n=0;n<a.length-1;n++)u=S(this,m[i+n],t,n),u===y&&(u=this._$AH[n]),r||=!C(u)||u!==this._$AH[n],u===c?e=c:e!==c&&(e+=(u??"")+a[n+1]),this._$AH[n]=u}r&&!s&&this.j(e)}j(e){e===c?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},V=class extends E{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===c?void 0:e}},J=class extends E{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==c)}},F=class extends E{constructor(e,t,i,s,a){super(e,t,i,s,a),this.type=5}_$AI(e,t=this){if((e=S(this,e,t,0)??c)===y)return;let i=this._$AH,s=e===c&&i!==c||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,a=e!==c&&(i===c||s);s&&this.element.removeEventListener(this.name,this,i),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},W=class{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){S(this,e)}};var Je=K.litHtmlPolyfillSupport;Je?.(M,P),(K.litHtmlVersions??=[]).push("3.3.3");var Ee=(o,e,t)=>{let i=t?.renderBefore??e,s=i._$litPart$;if(s===void 0){let a=t?.renderBefore??null;i._$litPart$=s=new P(e.insertBefore(j(),a),a,void 0,t??{})}return s._$AI(o),s};var Z=globalThis,p=class extends b{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Ee(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return y}};p._$litElement$=!0,p.finalized=!0,Z.litElementHydrateSupport?.({LitElement:p});var Fe=Z.litElementPolyfillSupport;Fe?.({LitElement:p});(Z.litElementVersions??=[]).push("4.2.2");var Q=class extends p{static properties={headerItems:{type:Array},currentPage:{type:String}};constructor(){super(),this.headerItems=[],this.currentPage=""}static styles=h`
      :host {
        display: block;
        margin: 0;
    ...
    `}};customElements.define("po-template",Q);var ee=class extends p{static properties={title:{type:String},description:{type:String},img:{type:String},socialLinks:{type:Array},buttonText:{type:String},navigation:{type:String}};constructor(){super(),this.title="Bienvenido",this.description="Explora mi portafolio para descubrir mis proyectos y habilidades.",this.socialLinks=[],this.buttonText="Descubre m\xE1s",this.navigation="#"}static styles=h`
    :host {
      display: block;
      margin: 0 auto;
      padding: 40px;
  ...
  `;_handleButtonClick(){let e=new CustomEvent("navigate",{detail:{page:this.navigation},bubbles:!0,composed:!0});this.dispatchEvent(e)}render(){return l`
    ...
    `}};customElements.define("po-card-jumbo",ee);var we={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Te=o=>(...e)=>({_$litDirective$:o,values:e}),R=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};var L=class extends R{constructor(e){if(super(e),this.it=c,e.type!==we.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===c||e==null)return this._t=void 0,this.it=e;if(e===y)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;let t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}};L.directiveName="unsafeHTML",L.resultType=1;var ke=Te(L);var te=class extends p{static properties={img:{type:String},title:{type:String},subtitle:{type:String},description:{type:String},modalTemplate:{type:String},_isModalOpen:{state:!0},_modalContent:{state:!0}};constructor(){super(),this._isModalOpen=!1,this._modalContent=""}static styles=h`
    :host {
      display: block;
      font-family: Arial, sans-serif;
      max-width: 280px;
  ...
  `;async _openModal(){if(this.modalTemplate)try{let e=await fetch(this.modalTemplate);e.ok?(this._modalContent=await e.text(),this._isModalOpen=!0):console.error("Failed to load template:",e.status)}catch(e){console.error("Error loading template:",e)}}_closeModal(){this._isModalOpen=!1}render(){return l`
      ...
      <div class="modal ${this._isModalOpen?"open":""}">
        <div class="modal-content">
          ...
          <div class="modal-description">${ke(this._modalContent)}</div>
          <a @click=${this._closeModal} class="modal-close">cerrar</a>
        </div>
      </div>
    `}};customElements.define("po-card-img",te);var ie=class extends p{static properties={title:{type:String},items:{type:Array},mode:{type:String}};constructor(){super(),this.mode="full"}static styles=h`
    :host {
      display: block;
      font-family: Arial, sans-serif;
    }
  ...
  `;render(){return l`
    ...
    `}};customElements.define("po-container-items",ie);var se=class extends p{constructor(){super()}firstUpdated(){let e=this.shadowRoot.querySelector("po-card-jumbo"),t=document.createElement("link");t.rel="stylesheet",t.href="./dist/fonts/fontello.css",e.shadowRoot.appendChild(t)}static styles=h`
      :host {
        display: block;
      }
    ...
    `;render(){return l`
      <section>
        <po-card-jumbo
          ...
          title="Welcome"
          navigation="profile"
          description="Descubre quien soy y a lo que me dedico. Encontrarás un pedacito de mi alma en cada uno de mis proyectos. No te conformes solo con mirar, explora, sumérgete y deja que cada idea te inspire. ¡Adelante!"
  ...
  `;render(){return l`
      <section>
        <po-container-items mode="full" .items=${Me}></po-container-items>
