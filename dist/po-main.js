...
\f\r"'\`<>=]|("|')|))|$)`,"g"),fe=/'/g,be=/"/g,$e=/^(?:script|style|textarea|title)$/i,Y=o=>(e,...t)=>({_$litType$:o,strings:e,values:t}),l=Y(1),Ke=Y(2),Qe=Y(3),y=Symbol.for("lit-noChange"),c=Symbol.for("lit-nothing"),ye=new WeakMap,A=_.createTreeWalker(_,129);function Ae(o,e){if(!Q(o)||!o.hasOwnProperty("raw"))throw Error("invalid template strings array");return he!==void 0?he.createHTML(e):e}var qe=(o,e)=>{let t=o.length-1,i=[],s,a=e===2?"<svg>":e===3?"<math>":"",r=T;for(let g=0;g<t;g++){let n=o[g],h,u,p=-1,f=0;for(;f<n.length&&(r.lastIndex=f,u=r.exec(n),u!==null);)f=r.lastIndex,r===T?u[1]==="!--"?r=ue:u[1]!==void 0?r=ge:u[2]!==void 0?($e.test(u[2])&&(s=RegExp("</"+u[2],"g")),r=$):u[3]!==void 0&&(r=$):r===$?u[0]===">"?(r=s??T,p=-1):u[1]===void 0?p=-2:(p=r.lastIndex-u[2].length,h=u[1],r=u[3]===void 0?$:u[3]==='"'?be:fe):r===be||r===fe?r=$:r===ue||r===ge?r=T:(r=$,s=void 0);let x=r===$&&o[g+1].startsWith("/>")?" ":"";a+=r===T?n+De:p>=0?(i.push(h),n.slice(0,p)+xe+n.slice(p)+v+x):n+v+(p===-2?g:x)}return[Ae(o,a+(o[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]},M=class o{constructor({strings:e,_$litType$:t},i){let s;this.parts=[];let a=0,r=0,g=e.length-1,n=this.parts,[h,u]=qe(e,t);if(this.el=o.createElement(h,i),A.currentNode=this.el.content,t===2||t===3){let p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(s=A.nextNode())!==null&&n.length<g;){if(s.nodeType===1){if(s.hasAttributes())for(let p of s.getAttributeNames())if(p.endsWith(xe)){let f=u[r++],x=s.getAttribute(p).split(v),U=/([.?@])?(.*)/.exec(f);n.push({type:1,index:a,name:U[2],strings:x,ctor:U[1]==="."?V:U[1]==="?"?F:U[1]==="@"?W:E}),s.removeAttribute(p)}else p.startsWith(v)&&(n.push({type:6,index:a}),s.removeAttribute(p));if($e.test(s.tagName)){let p=s.textContent.split(v),f=p.length-1;if(f>0){s.textContent=N?N.emptyScript:"";for(let x=0;x<f;x++)s.append(p[x],j()),A.nextNode(),n.push({type:2,index:++a});s.append(p[f],j())}}}else if(s.nodeType===8)if(s.data===ve)n.push({type:2,index:a});else{let p=-1;for(;(p=s.data.indexOf(v,p+1))!==-1;)n.push({type:7,index:a}),p+=v.length-1}a++}}static createElement(e,t){let i=_.createElement("template");return i.innerHTML=e,i}};function S(o,e,t=o,i){if(e===y)return e;let s=i!==void 0?t.o?.[i]:t.l,a=C(e)?void 0:e._$litDirective$;return s?.constructor!==a&&(s?._$AO?.(!1),a===void 0?s=void 0:(s=new a(o),s._$AT(o,t,i)),i!==void 0?(t.o??=[])[i]=s:t.l=s),s!==void 0&&(e=S(o,s._$AS(o,e.values),s,i)),e}var J=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:i}=this._$AD,s=(e?.creationScope??_).importNode(t,!0);A.currentNode=s;let a=A.nextNode(),r=0,g=0,n=i[0];for(;n!==void 0;){if(r===n.index){let h;n.type===2?h=new P(a,a.nextSibling,this,e):n.type===1?h=new n.ctor(a,n.name,n.strings,this,e):n.type===6&&(h=new X(a,this,e)),this._$AV.push(h),n=i[++g]}r!==n?.index&&(a=A.nextNode(),r++)}return A.currentNode=_,s}p(e){let t=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}},P=class o{get _$AU(){return this._$AM?._$AU??this.v}constructor(e,t,i,s){this.type=2,this._$AH=c,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=s,this.v=s?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=S(this,e,t),C(e)?e===c||e==null||e===""?(this._$AH!==c&&this._$AR(),this._$AH=c):e!==this._$AH&&e!==y&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Ie(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==c&&C(this._$AH)?this._$AA.nextSibling.data=e:this.T(_.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:i}=e,s=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=M.createElement(Ae(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(t);else{let a=new J(s,this),r=a.u(this.options);a.p(t),this.T(r),this._$AH=a}}_$AC(e){let t=ye.get(e.strings);return t===void 0&&ye.set(e.strings,t=new M(e)),t}k(e){Q(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,i,s=0;for(let a of e)s===t.length?t.push(i=new o(this.O(j()),this.O(j()),this,this.options)):i=t[s],i._$AI(a),s++;s<t.length&&(this._$AR(i&&i._$AB.nextSibling,s),t.length=s)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e&&e!==this._$AB;){let i=e.nextSibling;e.remove(),e=i}}setConnected(e){this._$AM===void 0&&(this.v=e,this._$AP?.(e))}},E=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,s,a){this.type=1,this._$AH=c,this._$AN=void 0,this.element=e,this.name=t,this._$AM=s,this.options=a,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=c}_$AI(e,t=this,i,s){let a=this.strings,r=!1;if(a===void 0)e=S(this,e,t,0),r=!C(e)||e!==this._$AH&&e!==y,r&&(this._$AH=e);else{let g=e,n,h;for(e=a[0],n=0;n<a.length-1;n++)h=S(this,g[i+n],t,n),h===y&&(h=this._$AH[n]),r||=!C(h)||h!==this._$AH[n],h===c?e=c:e!==c&&(e+=(h??"")+a[n+1]),this._$AH[n]=h}r&&!s&&this.j(e)}j(e){e===c?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},V=class extends E{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===c?void 0:e}},F=class extends E{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==c)}},W=class extends E{constructor(e,t,i,s,a){super(e,t,i,s,a),this.type=5}_$AI(e,t=this){if((e=S(this,e,t,0)??c)===y)return;let i=this._$AH,s=e===c&&i!==c||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,a=e!==c&&(i===c||s);s&&this.element.removeEventListener(this.name,this,i),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},X=class{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){S(this,e)}};var Ge=K.litHtmlPolyfillSupport;Ge?.(M,P),(K.litHtmlVersions??=[]).push("3.2.0");var _e=(o,e,t)=>{let i=t?.renderBefore??e,s=i._$litPart$;if(s===void 0){let a=t?.renderBefore??null;i._$litPart$=s=new P(e.insertBefore(j(),a),a,void 0,t??{})}return s._$AI(o),s};var d=class extends b{constructor(){super(...arguments),this.renderOptions={host:this},this.o=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this.o=_e(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this.o?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this.o?.setConnected(!1)}render(){return y}};d._$litElement$=!0,d.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:d});var Je=globalThis.litElementPolyfillSupport;Je?.({LitElement:d});(globalThis.litElementVersions??=[]).push("4.1.0");var Z=class extends d{static properties={headerItems:{type:Array},currentPage:{type:String}};constructor(){super(),this.headerItems=[],this.currentPage=""}static styles=m`
    ...
    `}};customElements.define("po-template",Z);var ee=class extends d{static properties={title:{type:String},description:{type:String},img:{type:String},socialLinks:{type:Array},buttonText:{type:String},navigation:{type:String}};constructor(){super(),this.title="Bienvenido",this.description="Explora mi portafolio para descubrir mis proyectos y habilidades.",this.socialLinks=[],this.buttonText="Descubre m\xE1s",this.navigation="#"}static styles=m`
    :host {
      display: block;
      margin: 0 auto;
      padding: 40px;
  ...
  `;async _openModal(){if(this.modalTemplate)try{let e=await fetch(this.modalTemplate);e.ok?(this._modalContent=await e.text(),this._isModalOpen=!0):console.error("Failed to load template:",e.status)}catch(e){console.error("Error loading template:",e)}}_closeModal(){this._isModalOpen=!1}render(){return l`
    ...
    `}};customElements.define("po-card-img",te);var ie=class extends d{static properties={title:{type:String},items:{type:Array},mode:{type:String}};constructor(){super(),this.mode="full"}static styles=m`
    :host {
      display: block;
      font-family: Arial, sans-serif;
    }
  ...
  `;render(){return l`
    ...
    `}};customElements.define("po-container-items",ie);var se=class extends d{constructor(){super()}firstUpdated(){let e=this.shadowRoot.querySelector("po-card-jumbo"),t=document.createElement("link");t.rel="stylesheet",t.href="./dist/fonts/fontello.css",e.shadowRoot.appendChild(t)}static styles=m`
      :host {
        display: block;
      }
  ...
  `;render(){return l`
    ...
    `}};customElements.define("po-page-personal",re);var ne=class extends d{static properties={currentPage:{type:String}};constructor(){super(),this.currentPage="home",console.log(`
